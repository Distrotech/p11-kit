                       ...
                       CK_ULONG *n_array)
{
	...
	if (!_p11_buffer_get_byte_array (msg->input, msg->parsed, &msg->parsed,
	                                 &data, &n_data))
		return PARSE_ERROR;
                             ...
                             CK_ULONG *n_result)
{
	...
	if (!_p11_buffer_get_uint32 (msg->input, msg->parsed, &msg->parsed, &n_attrs))
		return PARSE_ERROR;
...
static CK_RV
rpc_C_Initialize (P11RpcServerVtable *vtable,
                  ...
                  RpcMessage *msg)
{
	...
	_p11_debug ("ret: %d", (int)ret);
	return ret;
}

static CK_RV
rpc_C_Finalize (P11RpcServerVtable *vtable,
                CK_FUNCTION_LIST_PTR module,
                RpcMessage *msg)
{
...
static CK_RV
rpc_C_GetInfo (P11RpcServerVtable *vtable,
               CK_FUNCTION_LIST_PTR module,
               RpcMessage *msg)
{
	CK_INFO info;
...
static CK_RV
rpc_C_GetSlotList (P11RpcServerVtable *vtable,
                   CK_FUNCTION_LIST_PTR module,
                   RpcMessage *msg)
{
...
static CK_RV
rpc_C_GetSlotInfo (P11RpcServerVtable *vtable,
                   CK_FUNCTION_LIST_PTR module,
                   RpcMessage *msg)
{
	CK_SLOT_ID slot_id;
...
static CK_RV
rpc_C_GetTokenInfo (P11RpcServerVtable *vtable,
                    CK_FUNCTION_LIST_PTR module,
                    RpcMessage *msg)
{
	CK_SLOT_ID slot_id;
...
static CK_RV
rpc_C_GetMechanismList (P11RpcServerVtable *vtable,
                        CK_FUNCTION_LIST_PTR module,
                        RpcMessage *msg)
{
	CK_SLOT_ID slot_id;
...
static CK_RV
rpc_C_GetMechanismInfo (P11RpcServerVtable *vtable,
                        CK_FUNCTION_LIST_PTR module,
                        RpcMessage *msg)
{
	CK_SLOT_ID slot_id;
...
static CK_RV
rpc_C_InitToken (P11RpcServerVtable *vtable,
                 CK_FUNCTION_LIST_PTR module,
                 RpcMessage *msg)
{
	CK_SLOT_ID slot_id;
...
static CK_RV
rpc_C_WaitForSlotEvent (P11RpcServerVtable *vtable,
                        CK_FUNCTION_LIST_PTR module,
                        RpcMessage *msg)
{
	CK_FLAGS flags;
...
static CK_RV
rpc_C_OpenSession (P11RpcServerVtable *vtable,
                   CK_FUNCTION_LIST_PTR module,
                   RpcMessage *msg)
{
	CK_SLOT_ID slot_id;
...
static CK_RV
rpc_C_CloseSession (P11RpcServerVtable *vtable,
                    CK_FUNCTION_LIST_PTR module,
                    RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_CloseAllSessions (P11RpcServerVtable *vtable,
                        CK_FUNCTION_LIST_PTR module,
                        RpcMessage *msg)
{
	CK_SLOT_ID slot_id;
...
static CK_RV
rpc_C_GetFunctionStatus (P11RpcServerVtable *vtable,
                         CK_FUNCTION_LIST_PTR module,
                         RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_CancelFunction (P11RpcServerVtable *vtable,
                      CK_FUNCTION_LIST_PTR module,
                      RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_GetSessionInfo (P11RpcServerVtable *vtable,
                      CK_FUNCTION_LIST_PTR module,
                      RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_InitPIN (P11RpcServerVtable *vtable,
               CK_FUNCTION_LIST_PTR module,
               RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_SetPIN (P11RpcServerVtable *vtable,
              CK_FUNCTION_LIST_PTR module,
              RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_GetOperationState (P11RpcServerVtable *vtable,
                         CK_FUNCTION_LIST_PTR module,
                         RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_SetOperationState (P11RpcServerVtable *vtable,
                         CK_FUNCTION_LIST_PTR module,
                         RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_Login (P11RpcServerVtable *vtable,
             CK_FUNCTION_LIST_PTR module,
             RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_Logout (P11RpcServerVtable *vtable,
              CK_FUNCTION_LIST_PTR module,
              RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_CreateObject (P11RpcServerVtable *vtable,
                    CK_FUNCTION_LIST_PTR module,
                    RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_CopyObject (P11RpcServerVtable *vtable,
                  CK_FUNCTION_LIST_PTR module,
                  RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_DestroyObject (P11RpcServerVtable *vtable,
                     CK_FUNCTION_LIST_PTR module,
                     RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_GetObjectSize (P11RpcServerVtable *vtable,
                     CK_FUNCTION_LIST_PTR module,
                     RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_GetAttributeValue (P11RpcServerVtable *vtable,
                         CK_FUNCTION_LIST_PTR module,
                         RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_SetAttributeValue (P11RpcServerVtable *vtable,
                         CK_FUNCTION_LIST_PTR module,
                         RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_FindObjectsInit (P11RpcServerVtable *vtable,
                       CK_FUNCTION_LIST_PTR module,
                       RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_FindObjects (P11RpcServerVtable *vtable,
                   CK_FUNCTION_LIST_PTR module,
                   RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_FindObjectsFinal (P11RpcServerVtable *vtable,
                        CK_FUNCTION_LIST_PTR module,
                        RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_EncryptInit (P11RpcServerVtable *vtable,
                   CK_FUNCTION_LIST_PTR module,
                   RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_Encrypt (P11RpcServerVtable *vtable,
               CK_FUNCTION_LIST_PTR module,
               RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_EncryptUpdate (P11RpcServerVtable *vtable,
                     CK_FUNCTION_LIST_PTR module,
                     RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_EncryptFinal (P11RpcServerVtable *vtable,
                    CK_FUNCTION_LIST_PTR module,
                    RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_DecryptInit (P11RpcServerVtable *vtable,
                   CK_FUNCTION_LIST_PTR module,
                   RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_Decrypt (P11RpcServerVtable *vtable,
               CK_FUNCTION_LIST_PTR module,
               RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_DecryptUpdate (P11RpcServerVtable *vtable,
                     CK_FUNCTION_LIST_PTR module,
                     RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_DecryptFinal (P11RpcServerVtable *vtable,
                    CK_FUNCTION_LIST_PTR module,
                    RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_DigestInit (P11RpcServerVtable *vtable,
                  CK_FUNCTION_LIST_PTR module,
                  RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_Digest (P11RpcServerVtable *vtable,
              CK_FUNCTION_LIST_PTR module,
              RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_DigestUpdate (P11RpcServerVtable *vtable,
                    CK_FUNCTION_LIST_PTR module,
                    RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_DigestKey (P11RpcServerVtable *vtable,
                 CK_FUNCTION_LIST_PTR module,
                 RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_DigestFinal (P11RpcServerVtable *vtable,
                   CK_FUNCTION_LIST_PTR module,
                   RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_SignInit (P11RpcServerVtable *vtable,
                CK_FUNCTION_LIST_PTR module,
                RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_Sign (P11RpcServerVtable *vtable,
            CK_FUNCTION_LIST_PTR module,
            RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_SignUpdate (P11RpcServerVtable *vtable,
                  CK_FUNCTION_LIST_PTR module,
                  RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_SignFinal (P11RpcServerVtable *vtable,
                 CK_FUNCTION_LIST_PTR module,
                 RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_SignRecoverInit (P11RpcServerVtable *vtable,
                       CK_FUNCTION_LIST_PTR module,
                       RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_SignRecover (P11RpcServerVtable *vtable,
                   CK_FUNCTION_LIST_PTR module,
                   RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_VerifyInit (P11RpcServerVtable *vtable,
                  CK_FUNCTION_LIST_PTR module,
                  RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_Verify (P11RpcServerVtable *vtable,
              CK_FUNCTION_LIST_PTR module,
              RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_VerifyUpdate (P11RpcServerVtable *vtable,
                    CK_FUNCTION_LIST_PTR module,
                    RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_VerifyFinal (P11RpcServerVtable *vtable,
                   CK_FUNCTION_LIST_PTR module,
                   RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_VerifyRecoverInit (P11RpcServerVtable *vtable,
                         CK_FUNCTION_LIST_PTR module,
                         RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_VerifyRecover (P11RpcServerVtable *vtable,
                     CK_FUNCTION_LIST_PTR module,
                     RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_DigestEncryptUpdate (P11RpcServerVtable *vtable,
                           CK_FUNCTION_LIST_PTR module,
                           RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_DecryptDigestUpdate (P11RpcServerVtable *vtable,
                           CK_FUNCTION_LIST_PTR module,
                           RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_SignEncryptUpdate (P11RpcServerVtable *vtable,
                         CK_FUNCTION_LIST_PTR module,
                         RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_DecryptVerifyUpdate (P11RpcServerVtable *vtable,
                           CK_FUNCTION_LIST_PTR module,
                           RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_GenerateKey (P11RpcServerVtable *vtable,
                   CK_FUNCTION_LIST_PTR module,
                   RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_GenerateKeyPair (P11RpcServerVtable *vtable,
                       CK_FUNCTION_LIST_PTR module,
                       RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_WrapKey (P11RpcServerVtable *vtable,
               CK_FUNCTION_LIST_PTR module,
               RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_UnwrapKey (P11RpcServerVtable *vtable,
                 CK_FUNCTION_LIST_PTR module,
                 RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_DeriveKey (P11RpcServerVtable *vtable,
                 CK_FUNCTION_LIST_PTR module,
                 RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_SeedRandom (P11RpcServerVtable *vtable,
                  CK_FUNCTION_LIST_PTR module,
                  RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
static CK_RV
rpc_C_GenerateRandom (P11RpcServerVtable *vtable,
                      CK_FUNCTION_LIST_PTR module,
                      RpcMessage *msg)
{
	CK_SESSION_HANDLE session;
...
int
p11_rpc_server_handle (P11RpcServerVtable *vtable,
                       CK_FUNCTION_LIST_PTR module,
                       P11Buffer *request,
                       P11Buffer *response)
{
	...
	return_val_if_fail (request != NULL, -1);
	return_val_if_fail (response != NULL, -1);

	_p11_kit_clear_message ();

	output = _p11_buffer_to_output (response);
	if (output == NULL)
		return -1;

	_p11_rpc_message_init (&msg, request, output);

	if (!_p11_rpc_message_parse (&msg, RPC_REQUEST)) {
		_p11_rpc_message_clear (&msg);
		_p11_message ("couldn't parse pkcs11 rpc message");
		return -1;
	}
	...
	case RPC_CALL_##name: \
		ret = rpc_##name (vtable, module, &msg); \
		break;
